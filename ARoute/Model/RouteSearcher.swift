...
class RouteSearcher {
    ...
    static func search(departure: String, destination: String) {
        let urlString = "https://api.apigw.smt.docomo.ne.jp/ekispertCorp/v1/searchCourseExtreme?APIKEY=6f4638646847384b557453786c3243746a5439512e4837672e5a315a4139634a737a392e76487476733441&viaList=\(departure):\(destination)&sort=transfer"
