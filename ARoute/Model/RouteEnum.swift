...
enum Route {
    ...
    private static func assignColor() {
        ...
        case .marunouchi:
            Route.color = #colorLiteral(red: 0.9529411765, green: 0.1882352941, blue: 0.2392156863, alpha: 1)
        case .ginza:
            Route.color = #colorLiteral(red: 0.9921568627, green: 0.5764705882, blue: 0.1490196078, alpha: 1)
        case .touzai:
            Route.color = #colorLiteral(red: 0.09411764706, green: 0.6078431373, blue: 0.737254902, alpha: 1)
        }
    }
    ...
    private static func assignCoordinate() {
        switch Route.currentRoute {
        case .yamanote:
            Route.coordinate =
